...
def get_gram_matrix(f_map):
    ...
    if n == 1:
        ...
        gram_matrix = torch.matmul(f_map, f_map.t())
        return gram_matrix
    else:
...
if __name__ == '__main__':
    ...
    while j <= epochs:
        for i, image in enumerate(data_loader):
            ...
            # TODO: 更新所有参数
            optimizer.step()
            print('j:', j, 'i:', i, 'loss:', loss.item(), 'loss_c:',
                  loss_c.item(), 'loss_s:', loss_s.item())
            count += 1
            ...
            if i % 10 == 0:
                ...
                save_image(torch.cat((mlu_image_c, mlu_image_g), -1),
                           f'out/train_mlu/result_{j}_{i}.jpg')
        j += 1
